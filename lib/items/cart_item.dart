...
class CartItem extends StatelessWidget {
  ...
  const CartItem({Key? key, required this.foodCount}) : super(key: key);
  @override
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Text(
              'x${foodCount.count}',
              style: TextStyle(color: Colors.white, fontSize: doubleWidth(4)),
            ),
          )),
          Expanded(
            flex: 6,
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        foodCount.food.name,
                        style: TextStyle(
                            color: Colors.white, fontSize: doubleWidth(4)),
                      ),
                      GestureDetector(
                          onTap: () {
